...
//
// On Sun May 26 22:35:13 -03 2024
//
//
// Ports:
// Name                         I/O  size props
...
module mkTb(CLK,
  ...
  // ports of submodule coarseFreq
  wire [47 : 0] coarseFreq$addSample_sample;
  wire [23 : 0] coarseFreq$getError;
  wire coarseFreq$EN_addSample,
       coarseFreq$EN_getError,
       coarseFreq$RDY_addSample,
       coarseFreq$RDY_getError;
  ...
  wire abort_whas_AND_abort_wget_OR_state_mkFSMstate__ETC___d78,
       n_6_ULT_10___d37;

  // value method outM
  assign OUT = outV[11:0] ;

  // submodule coarseFreq
  mkCoarseFreqO coarseFreq(.CLK(CLK),
			   .RST_N(RST_N),
			   .addSample_sample(coarseFreq$addSample_sample),
			   .EN_addSample(coarseFreq$EN_addSample),
			   .EN_getError(coarseFreq$EN_getError),
			   .RDY_addSample(coarseFreq$RDY_addSample),
			   .getError(coarseFreq$getError),
			   .RDY_getError(coarseFreq$RDY_getError));

  // rule RL_action_l40c23
  assign WILL_FIRE_RL_action_l40c23 =
	     coarseFreq$RDY_addSample && n_6_ULT_10___d37 &&
	     (state_mkFSMstate == 3'd2 || state_mkFSMstate == 3'd5) ;

  // rule RL_action_l41c13
  assign WILL_FIRE_RL_action_l41c13 =
	     coarseFreq$RDY_getError && state_mkFSMstate == 3'd3 ;

  // rule RL_fsm_start
  assign WILL_FIRE_RL_fsm_start =
	     abort_whas_AND_abort_wget_OR_state_mkFSMstate__ETC___d78 &&
	     start_reg ;

  // rule RL_action_l28c11
  assign WILL_FIRE_RL_action_l28c11 =
	     start_wire$whas && state_mkFSMstate == 3'd0 ||
	     !n_6_ULT_10___d37 && start_wire$whas &&
  ...
  // register outV
  assign outV$D_IN = coarseFreq$getError ;
  ...
  // submodule coarseFreq
  assign coarseFreq$addSample_sample = {2{fV}} ;
  assign coarseFreq$EN_addSample = WILL_FIRE_RL_action_l40c23 ;
  assign coarseFreq$EN_getError = WILL_FIRE_RL_action_l41c13 ;

  // remaining internal signals
  assign abort_whas_AND_abort_wget_OR_state_mkFSMstate__ETC___d78 =
	     (state_mkFSMstate == 3'd0 ||
	      !n_6_ULT_10___d37 && state_mkFSMstate == 3'd2 ||
	      !n_6_ULT_10___d37 && state_mkFSMstate == 3'd5) &&
	     (!start_reg_1 || state_fired) ;
  assign n_6_ULT_10___d37 = n < 10'd10 ;
