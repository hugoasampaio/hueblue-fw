...
/* String declarations */
static std::string const __str_literal_1("Error: \"Tb.bsv\", line 18, column 18: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l18c18] and\n  [RL_action_l20c20, RL_action_l23c20, RL_action_l24c23, RL_action_l26c13,\n  RL_action_l32c13] ) fired in the same clock cycle.\n",
					 241u);
static std::string const __str_literal_2("Error: \"Tb.bsv\", line 20, column 20: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l20c20] and\n  [RL_action_l23c20, RL_action_l24c23, RL_action_l26c13, RL_action_l32c13] )\n  fired in the same clock cycle.\n",
					 223u);
static std::string const __str_literal_3("Error: \"Tb.bsv\", line 23, column 20: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l23c20] and\n  [RL_action_l24c23, RL_action_l26c13, RL_action_l32c13] ) fired in the same\n  clock cycle.\n",
					 205u);
static std::string const __str_literal_4("Error: \"Tb.bsv\", line 24, column 23: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l24c23] and\n  [RL_action_l26c13, RL_action_l32c13] ) fired in the same clock cycle.\n",
					 185u);
static std::string const __str_literal_5("Error: \"Tb.bsv\", line 26, column 13: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l26c13] and\n  [RL_action_l32c13] ) fired in the same clock cycle.\n",
					 167u);
...
MOD_mkTb::MOD_mkTb(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    ...
    INST_result(simHdl, "result", this, 16u, 0u, (tUInt8)0u),
...
void MOD_mkTb::init_symbols_0()
{
  ...
  init_symbol(&symbols[6u], "b__h6865", SYM_DEF, &DEF_b__h6865, 8u);
  ...
  init_symbol(&symbols[11u], "RL_action_l20c20", SYM_RULE);
  ...
  init_symbol(&symbols[15u], "RL_action_l32c13", SYM_RULE);
  ...
  init_symbol(&symbols[39u],
	      "WILL_FIRE_RL_action_l20c20",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_action_l20c20,
	      1u);
  ...
  init_symbol(&symbols[43u],
	      "WILL_FIRE_RL_action_l32c13",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_action_l32c13,
	      1u);
}
...
void MOD_mkTb::RL_state_every()
{
  ...
  tUInt8 DEF_state_can_overlap__h2823;
  DEF_state_can_overlap__h2823 = INST_state_can_overlap.METH_read();
  DEF_state_set_pw_whas__6_OR_NOT_state_overlap_pw_w_ETC___d21 = INST_state_set_pw.METH_whas() || (!INST_state_overlap_pw.METH_whas() && DEF_state_can_overlap__h2823);
...
void MOD_mkTb::RL_action_l18c18()
{
  ...
  DEF_b__h6865 = INST_loop.METH_read();
  DEF_loop_2_PLUS_1___d44 = (tUInt8)255u & (DEF_b__h6865 + (tUInt8)1u);
...
void MOD_mkTb::RL_action_l20c20()
{
...
void MOD_mkTb::RL_action_l32c13()
{
  tUInt32 DEF_b__h23103;
  tUInt32 DEF_signed_result_0___d71;
  DEF_b__h23103 = INST_result.METH_read();
  DEF_signed_result_0___d71 = DEF_b__h23103;
  INST_state_mkFSMstate.METH_write((tUInt8)6u);
  INST_state_fired_1.METH_wset((tUInt8)1u);
  INST_state_set_pw.METH_wset();
  if (!(PORT_RST_N == (tUInt8)0u))
    dollar_display(sim_hdl, this, "-16", DEF_signed_result_0___d71);
}
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_action_l18c18 && ((((DEF_WILL_FIRE_RL_action_l20c20 || DEF_WILL_FIRE_RL_action_l23c20) || DEF_WILL_FIRE_RL_action_l24c23) || DEF_WILL_FIRE_RL_action_l26c13) || DEF_WILL_FIRE_RL_action_l32c13))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_action_l20c20 && (((DEF_WILL_FIRE_RL_action_l23c20 || DEF_WILL_FIRE_RL_action_l24c23) || DEF_WILL_FIRE_RL_action_l26c13) || DEF_WILL_FIRE_RL_action_l32c13))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_action_l23c20 && ((DEF_WILL_FIRE_RL_action_l24c23 || DEF_WILL_FIRE_RL_action_l26c13) || DEF_WILL_FIRE_RL_action_l32c13))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_action_l24c23 && (DEF_WILL_FIRE_RL_action_l26c13 || DEF_WILL_FIRE_RL_action_l32c13))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_action_l26c13 && DEF_WILL_FIRE_RL_action_l32c13)
...
unsigned int MOD_mkTb::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_action_l20c20", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_action_l32c13", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "b__h6865", 8u);
...
void MOD_mkTb::vcd_defs(tVCDDumpType dt, MOD_mkTb &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF_WILL_FIRE_RL_action_l18c18 = DEF_WILL_FIRE_RL_action_l18c18;
      ...
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_action_l20c20) != DEF_WILL_FIRE_RL_action_l20c20)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_action_l20c20, 1u);
	backing.DEF_WILL_FIRE_RL_action_l20c20 = DEF_WILL_FIRE_RL_action_l20c20;
      }
      ++num;
	...
	backing.DEF_WILL_FIRE_RL_action_l26c13 = DEF_WILL_FIRE_RL_action_l26c13;
      ...
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_action_l32c13) != DEF_WILL_FIRE_RL_action_l32c13)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_action_l32c13, 1u);
	backing.DEF_WILL_FIRE_RL_action_l32c13 = DEF_WILL_FIRE_RL_action_l32c13;
      }
      ++num;
      if ((backing.DEF_b__h6865) != DEF_b__h6865)
      {
	vcd_write_val(sim_hdl, num, DEF_b__h6865, 8u);
	backing.DEF_b__h6865 = DEF_b__h6865;
      }
      ++num;
    }
    else
