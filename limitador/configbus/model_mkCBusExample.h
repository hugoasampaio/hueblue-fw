...
/* Generation options: */
#ifndef __model_mkCBusExample_h__
#define __model_mkCBusExample_h__
...
/* Class declaration for a model of mkCBusExample */
class MODEL_mkCBusExample : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkCBusExample *mkCBusExample_instance;
...
#endif /* ifndef __model_mkCBusExample_h__ */
